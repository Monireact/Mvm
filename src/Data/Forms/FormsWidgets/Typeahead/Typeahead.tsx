export const basicTypeHeadData = [
  ...
  export const newrequestmultiselect = [
    { name: "Desktop" },
    { name: "Inverter " },
    { name: "Laptop" },
    { name: "Projector " },
    { name: "test" },
    { name: "test " },
    { name: "Bus Spare Parts " },
  ];

  export const CategoriesMuliteselect=[
    { name: "Approve" },
    { name: "Upload" },
  ]
  export const RolesMuliteselect=[
    { name: "School Admin" },
    { name: "Catagory Head" },
  ...
  export const DepartmentMuliteselect=[
    { name: "Transport" },
    { name: "Admin" },
    { name: "IT " },
    { name: "Accounts" },
