                            ...
                            <thead>
                             ...
                             <tbody>
                                <tr>
                                    ...
                                    <td><Badge color="info" className='rounded-5'>More Info Requested</Badge></td>
                                    <td>
                                    <Link to={`${process.env.PUBLIC_URL}/approvalrequest/pendingrequestcloneview`}><i className="fa fa-eye"></i></Link>
                                    <span>  </span>
...
export default PendingRequestClone