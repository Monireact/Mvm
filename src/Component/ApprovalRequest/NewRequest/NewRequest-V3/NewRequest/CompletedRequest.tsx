                                    ...
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Request <code></code></th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>15-07-2024</td>
                                                <td>Medium</td>
                                                <td><Badge color="success" className='rounded-5'>Completed</Badge></td>
                                                <td>
                                                    <Link to={`${process.env.PUBLIC_URL}/approvalrequest/completedrequestview`}><i className="fa fa-eye"></i></Link>
                                                    <span>  </span>
