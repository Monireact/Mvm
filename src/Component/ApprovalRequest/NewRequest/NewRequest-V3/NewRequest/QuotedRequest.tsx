                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><Badge color='success' className='rounded-5'>Confirmed By School Head</Badge></td>
                        <td>
                          <Link to={`${process.env.PUBLIC_URL}/approvalrequest/quotedrequestview`}><i className="fa fa-eye"></i></Link>
                          <span>  </span>
