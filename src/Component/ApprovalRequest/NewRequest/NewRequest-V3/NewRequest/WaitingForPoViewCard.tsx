...
import { Col, Row, Media, Badge,  } from 'reactstrap'
  ...
  return (
    ...
    <div className="card-wrapper border rounded-3 checkbox-checked">
      ...
      <Col md="12" xl="6">
        ...
        <Row>
      <Col>  <H4 className="text-success my-3">{"PO Details"}</H4>
      </Col>
      <Col className='mt-2 offset-sm-5 d-flex gap-2'>
        {/* <BillUpdateModal/> 
        <StatusUpdateModal/> */}
      </Col>
  </Row>
        ...
        <tr>
          ...
          <td className=''>
            ...
            <UL className="action simple-list flex-row gap-3">
              <Link to={`${process.env.PUBLIC_URL}/approvalrequest/waitingforpoissued`}>{"View"}</Link>
              <BillUpdateModal/> 
              <StatusUpdateModal/>
            </UL>
            </Row>
...
export default WaitingForPoViewCard