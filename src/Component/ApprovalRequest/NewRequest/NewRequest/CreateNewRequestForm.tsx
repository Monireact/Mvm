...
import { categorydropdown, departmentdropdown, LinkDropdown, SchoolName } from '../../../../Data/Forms/FormsControl/BaseInput/BaseInput'
            ...
            <Row>
              ...
              <Col sm="8">
                <Input type='select' className="input-air-primary digits" defaultValue={"Select School"}>
                  {SchoolName.map((data, index) => (<option key={index}>{data}</option>))}
                </Input>
              </Col>
            </Row>
          </FormGroup>
        ...
        <Row className="justify-content-center">
          <Col md="6" className="d-flex flex-column col-md-6 ms-5 ">
            <div className="text-end offset-sm-1">
              <Link to={`${process.env.PUBLIC_URL}/approvalrequest/openrequest`}>
