...
import { Badge, Card, CardBody, Col, Collapse, Form, FormGroup, Input, Label, Media, Row, Table } from 'reactstrap'
...
const NewRequestQuotation = () => {
  ...
  return (
    <>
      ...
      <div className='d-flex gap-3 mt-3 offset-sm-6'>
        ...
        <div className="invoice-table custom-scrollbar" id="table">
          <Table bordered striped responsive>
            <thead className="thead-dark">
              <tr>
                <th className="col-3"><H6>Committee Member Name</H6></th>
                <th><H6>Quotation</H6></th>
                <th><H6>Decision</H6></th>
                <th><H6>Comments</H6></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td><P className="m-0">Kumar</P></td>
                <td><P className="itemtext">Quotation1</P></td>
                <td>
                  <div className='p-3'>
                    <P className="itemtext">Approved</P>
                  </div>
                </td>
                <td>
                  <P className="itemtext">JK Tyre & Industries Ltd. is a leading manufacturer in the tyre industry, known for its innovative products and extensive market presence."</P>
                </td>
              </tr>
              <tr>
                <td><P className="m-0">Reema</P></td>
                <td><P className="itemtext">Quotation2</P></td>
                <td>
                  <div className='p-3'>
                    <P className="itemtext">Approved</P>
                  </div>
                ...
                <td>
                  <P className="itemtext">Quality and Durability: MRF Tyres are known for their high-quality materials and construction, which contribute to their durability and longevity on the road.</P>
                </td>
              </tr>
              <tr>
                <td><P className="m-0">Ranjith</P></td>
                <td><P className="itemtext">Quotation3</P></td>
                <td>
                  <div className='p-3'>
                    <P className="itemtext">Approved</P>
                  </div>
                ...
                <td>
                  <P className="itemtext">Performance: They offer tyres that deliver excellent performance in terms of traction, stability, and handling, enhancing the overall driving experience..</P>
                </td>
              </tr>
            </tbody>
          </Table>
