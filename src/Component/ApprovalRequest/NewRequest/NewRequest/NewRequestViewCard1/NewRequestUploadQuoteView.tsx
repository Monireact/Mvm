...
return(
    ...
    <div className="card-wrapper border rounded-3 checkbox-checked">
                ...
                <tr>
                    ...
                    <td className=''>
                        <UL className="action simple-list flex-row gap-3">
                            <Link to={`${process.env.PUBLIC_URL}/approvalrequest/viewuploadquotation`}>{"View"}</Link>
        ...
        <Link to={`${process.env.PUBLIC_URL}/approvalrequest/viewrequestuploadquote`}>
          <Btn color='dark'>{"Upload Quote"}</Btn>
        </Link>
          <Btn color='info' onClick={needMoreInfoToggle}  >{"Need More Info"}</Btn>
          <Btn color='success' onClick={approveToggle} >{"Submit"}</Btn>
        </Col>
        <Col md="12" sm="12">
        <CardBody>
                ...
                <Form className="g-3">
                  <Row>
                    ...
                    <Col className='offset-sm-9 d-flex gap-1'>
                      <Link to={`${process.env.PUBLIC_URL}/approvalrequest/quotesubmitted`}>
...
export default NewRequestUploadQuote